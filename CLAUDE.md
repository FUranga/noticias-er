...
- `docs/boletin-oficial-proceso.md` — diseño de cómo `pipeline/monitorear_boletin_er.py` filtra y prioriza el Boletín Oficial de ER antes de cargarlo a la cablera. Leer antes de tocar ese script o de decidir qué se filtra/prioriza.
