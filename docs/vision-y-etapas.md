...
- **Accountability sobre anuncio**: tratan lo que dice un funcionario como una afirmación a verificar, no un hecho a reproducir (ej. la franquicia de Fact Check de Voice of San Diego).
