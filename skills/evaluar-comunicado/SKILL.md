...
3. **Leer contra el grano, no solo el ángulo que ofrece la fuente.** Antes de resumir el ángulo principal del comunicado, revisar:
   ...
   - **Vara baja para `docs/temas-a-seguir.md` (2026-09-04, definido por Francisco)**: no hace falta que la mención se vea como una pista de investigación clara. También anotar ahí una fecha prometida que valga la pena chequear más adelante (¿se cumplió o se retrasó?), un patrón de tipo de anuncio que se repite entre comunicados, o algo que suena controvertido/raro sin explicación — aunque el comunicado en sí se descarte como no noticiable. La lógica es documentar de más ahora para tener contexto disponible después, no decidir en el momento qué va a servir.
